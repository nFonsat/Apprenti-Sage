...
public class DicteeActivity extends SherlockActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				if(!reponseEditTxt.getText().toString().equals("") && reponseEditTxt.getText() != null){
					...
					if(reponseEditTxt.getText().toString().toLowerCase().equals(currentQuestion.toLowerCase())){
						...
						showMessageBox( "Tu as trouv� " + reponseEditTxt.getText().toString() + " alors que la r�ponse �tait " + currentQuestion + " Ton score est de " + nbrBonnesReponses + "/" + nbrReponses);
					}
		...
		ActionBarService.initActionBar(this, getSupportActionBar(), "Dict�e");
	}
